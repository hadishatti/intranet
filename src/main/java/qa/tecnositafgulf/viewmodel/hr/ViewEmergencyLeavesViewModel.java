 ...
 */
public class ViewEmergencyLeavesViewModel extends IntranetVM {
        ...
        Messagebox.show("Are you sure to cancel ?", "Warning", Messagebox.OK | Messagebox.CANCEL, Messagebox.EXCLAMATION, new EventListener<Event>() {
            public void onEvent(Event event) throws Exception {
                if (event.getName().equals("onOK")) {
                    service.deleteEmergencyLeave(request);
    ...
    public void modify(@BindingParam("item") final LeaveRequest request){
        ...
        params.put("emergencyToModify", request);
        ((Window) Executions.getCurrent().createComponents("/pages/hr/emergencyLeaveRegistration.zul", null, params)).doModal();
    }
